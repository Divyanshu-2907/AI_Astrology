...
const nakshatras10To18 = [
  {
    ...
    content: {
      ...
      fourPadas: [
        { pada: 1, description: "Aries Navamsha (0°00' - 3°20' Leo): Driven by Mars. Highly courageous, pioneering, and aggressive in asserting their authority. Natural leaders who lead from the front." },
        { pada: 2, description: "Taurus Navamsha (3°20' - 6°40' Leo): Driven by Venus. Focuses on the material wealth, luxury, and comforts associated with royalty and inheritance." },
        { pada: 3, description: "Gemini Navamsha (6°40' - 10°00' Leo): Driven by Mercury. The intellectual side of leadership. Excels in speech, diplomacy, and managing the affairs of the kingdom." },
        { pada: 4, description: "Cancer Navamsha (10°00' - 13°20' Leo): Driven by Moon. Deeply emotional and attached to family lineage, ancestors, and providing emotional security to their 'subjects'." }
      ],
  ...
  },
  {
    ...
    content: {
      ...
      fourPadas: [
        { pada: 1, description: "Leo Navamsha (13°20' - 16°40' Leo): Driven by Sun. Highly dramatic, confident, and seeks to be the center of attention in social settings. Extremely creative." },
        { pada: 2, description: "Virgo Navamsha (16°40' - 20°00' Leo): Driven by Mercury. The most hardworking pada of this Nakshatra. Applies analytical skills to artistic and creative pursuits." },
        { pada: 3, description: "Libra Navamsha (20°00' - 23°20' Leo): Driven by Venus. The absolute peak of Venusian energy. Highly romantic, diplomatic, and obsessed with aesthetics and harmony." },
        { pada: 4, description: "Scorpio Navamsha (23°20' - 26°40' Leo): Driven by Mars. The most intense and passionate pada. Seeks deep, transformative experiences through romance and art." }
      ],
  ...
  },
  {
    ...
    content: {
      ...
      fourPadas: [
        { pada: 1, description: "Sagittarius Navamsha (26°40' Leo - 0°00' Virgo): Driven by Jupiter. Highly moral, philosophical, and optimistic. Focuses on leading and guiding others through wisdom." },
        { pada: 2, description: "Capricorn Navamsha (0°00' - 3°20' Virgo): Driven by Saturn. Extremely organized, disciplined, and hardworking. Focuses on building massive, practical structures of support." },
        { pada: 3, description: "Aquarius Navamsha (3°20' - 6°40' Virgo): Driven by Saturn. Highly altruistic and humanitarian. Uses their organizational skills for the betterment of large groups and society." },
        { pada: 4, description: "Pisces Navamsha (6°40' - 10°00' Virgo): Driven by Jupiter. The most compassionate and empathetic pada. Focuses heavily on spiritual service and healing others." }
      ],
  ...
  },
  {
    ...
    content: {
      ...
      fourPadas: [
        { pada: 1, description: "Aries Navamsha (10°00' - 13°20' Virgo): Driven by Mars. The most active and aggressive pada. Excellent for mechanics, surgery, and rapid, precise physical action." },
        { pada: 2, description: "Taurus Navamsha (13°20' - 16°40' Virgo): Driven by Venus. Highly artistic and grounded. Uses manual dexterity to create beauty, such as sculpting, painting, or jewelry making." },
        { pada: 3, description: "Gemini Navamsha (16°40' - 20°00' Virgo): Driven by Mercury. The pinnacle of intellectual and communicative skill. Excellent for writers, speakers, accountants, and traders." },
        { pada: 4, description: "Cancer Navamsha (20°00' - 23°20' Virgo): Driven by Moon. Highly empathetic and nurturing. Uses the hands for healing, such as massage therapy, Reiki, or cooking." }
      ],
  ...
  },
  {
    ...
    content: {
      ...
      fourPadas: [
        { pada: 1, description: "Leo Navamsha (23°20' - 26°40' Virgo): Driven by Sun. Highly dramatic, authoritative, and focused on personal brilliance and self-expression. Excellent leaders." },
        { pada: 2, description: "Virgo Navamsha (26°40' - 30°00' Virgo): Driven by Mercury. The most analytical and perfectionist pada. Vargottama placement, making them unparalleled in technical design." },
        { pada: 3, description: "Libra Navamsha (0°00' - 3°20' Libra): Driven by Venus. Vargottama placement. The most artistic, social, and relationship-oriented pada. Highly focused on aesthetics." },
        { pada: 4, description: "Scorpio Navamsha (3°20' - 6°40' Libra): Driven by Mars. The most intense and mystical pada. Seeks to design and structure the hidden, occult, or psychological realms." }
      ],
  ...
  },
  {
    ...
    content: {
      ...
      fourPadas: [
        { pada: 1, description: "Sagittarius Navamsha (6°40' - 10°00' Libra): Driven by Jupiter. Highly philosophical, optimistic, and seeks freedom through knowledge and long-distance travel." },
        { pada: 2, description: "Capricorn Navamsha (10°00' - 13°20' Libra): Driven by Saturn. Highly ambitious and practical. Uses their diplomatic skills to climb the corporate or social ladder." },
        { pada: 3, description: "Aquarius Navamsha (13°20' - 16°40' Libra): Driven by Saturn. Extremely independent, humanitarian, and unconventional. Vargottama in essence (air in air), creating a brilliant, innovative mind." },
        { pada: 4, description: "Pisces Navamsha (16°40' - 20°00' Libra): Driven by Jupiter. The most spiritual and empathetic pada. Highly adaptable, but can be overly yielding and prone to escapism." }
      ],
  ...
  },
  {
    ...
    content: {
      ...
      fourPadas: [
        { pada: 1, description: "Aries Navamsha (20°00' - 23°20' Libra): Driven by Mars. Highly aggressive, pioneering, and competitive. Will fiercely fight for their goals and beliefs." },
        { pada: 2, description: "Taurus Navamsha (23°20' - 26°40' Libra): Driven by Venus. Focuses their intense ambition on acquiring material wealth, luxury, and artistic perfection." },
        { pada: 3, description: "Gemini Navamsha (26°40' - 30°00' Libra): Driven by Mercury. The intellectual warrior. Excellent at debate, communication, and outsmarting their opponents." },
        { pada: 4, description: "Cancer Navamsha (0°00' - 3°20' Scorpio): Driven by Moon. The most intense and emotionally turbulent pada. Ambition is driven by deep psychological needs and occult interests." }
      ],
  ...
  },
  {
    ...
    content: {
      ...
      fourPadas: [
        { pada: 1, description: "Leo Navamsha (3°20' - 6°40' Scorpio): Driven by Sun. Highly dignified, proud, and seeks leadership roles within their spiritual or social communities." },
        { pada: 2, description: "Virgo Navamsha (6°40' - 10°00' Scorpio): Driven by Mercury. Highly analytical and practical. Excels at organizing people and deep, structured research." },
        { pada: 3, description: "Libra Navamsha (10°00' - 13°20' Scorpio): Driven by Venus. The most artistic and sociable pada. Excels in diplomacy, forming alliances, and creating harmony in dark situations." },
        { pada: 4, description: "Scorpio Navamsha (13°20' - 16°40' Scorpio): Driven by Mars. Vargottama placement. Extremely intense, deeply occult-oriented, and undergoes massive emotional transformations." }
      ],
  ...
  },
  {
    ...
    content: {
      ...
      fourPadas: [
        { pada: 1, description: "Sagittarius Navamsha (16°40' - 20°00' Scorpio): Driven by Jupiter. Highly philosophical and moral. Uses their authority and sharp intellect to fight for justice and higher truths." },
        { pada: 2, description: "Capricorn Navamsha (20°00' - 23°20' Scorpio): Driven by Saturn. Highly disciplined, ambitious, and practical. Excellent at building and maintaining structures of power." },
        { pada: 3, description: "Aquarius Navamsha (23°20' - 26°40' Scorpio): Driven by Saturn. Unconventional, scientific, and humanitarian. Uses their authority to protect the masses and innovate." },
        { pada: 4, description: "Pisces Navamsha (26°40' - 30°00' Scorpio): Driven by Jupiter. The Gandanta point. Extremely emotional, mystical, and prone to profound spiritual crises and awakenings." }
      ],
...
export const nakshatras10To18: NakshatraData[] = ${JSON.stringify(nakshatras10To18, null, 2)};
`;

fs.writeFileSync('src/data/nakshatras2.ts', fileContentEn);
console.log('Successfully wrote nakshatras2.ts');
