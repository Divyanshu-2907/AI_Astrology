...
const zodiacs = [
  {
    ...
    content: {
      ...
      decans: [
        { decan: 1, description: 'Mars Sub-ruler (0°-10°): The most pure Aries energy. Highly aggressive, pioneering, independent, and prone to impulsive actions.' },
        { decan: 2, description: 'Sun Sub-ruler (10°-20°): Adds Leo qualities. More dignified, proud, and focused on leadership, creativity, and public recognition.' },
        { decan: 3, description: 'Jupiter Sub-ruler (20°-30°): Adds Sagittarius qualities. More philosophical, optimistic, adventurous, and focused on higher learning or travel.' }
      ],
  ...
  },
  {
    ...
    content: {
      ...
      decans: [
        { decan: 1, description: 'Venus Sub-ruler (0°-10°): Pure Taurus energy. Highly focused on sensuality, material wealth, physical beauty, and unwavering stability.' },
        { decan: 2, description: 'Mercury Sub-ruler (10°-20°): Adds Virgo qualities. More analytical, practical, detailed-oriented, and focused on service or craftsmanship.' },
        { decan: 3, description: 'Saturn Sub-ruler (20°-30°): Adds Capricorn qualities. Highly disciplined, ambitious, focused on long-term structures and career success.' }
      ],
  ...
  },
  {
    ...
    content: {
      ...
      decans: [
        { decan: 1, description: 'Mercury Sub-ruler (0°-10°): Pure Gemini. Highly communicative, restless, curious, and perpetually youthful in mind.' },
        { decan: 2, description: 'Venus Sub-ruler (10°-20°): Adds Libra qualities. More focused on social grace, diplomacy, relationships, and aesthetic communication.' },
        { decan: 3, description: 'Uranus/Saturn Sub-ruler (20°-30°): Adds Aquarius qualities. Highly innovative, eccentric, humanitarian, and focused on collective ideas.' }
      ],
  ...
  },
  {
    ...
    content: {
      ...
      decans: [
        { decan: 1, description: 'Moon Sub-ruler (0°-10°): Pure Cancer. Supremely emotional, deeply attached to home/mother, highly intuitive, and protective.' },
        { decan: 2, description: 'Pluto/Mars Sub-ruler (10°-20°): Adds Scorpio qualities. More intense, secretive, deeply transformative, and emotionally resilient.' },
        { decan: 3, description: 'Neptune/Jupiter Sub-ruler (20°-30°): Adds Pisces qualities. Highly imaginative, mystical, unconditionally loving, and prone to escapism.' }
      ],
  ...
  },
  {
    ...
    content: {
      ...
      decans: [
        { decan: 1, description: 'Sun Sub-ruler (0°-10°): Pure Leo. Highly theatrical, proud, warm-hearted, and strongly focused on self-expression and leadership.' },
        { decan: 2, description: 'Jupiter Sub-ruler (10°-20°): Adds Sagittarius qualities. More philosophical, adventurous, optimistic, and focused on higher learning.' },
        { decan: 3, description: 'Mars Sub-ruler (20°-30°): Adds Aries qualities. More aggressive, impulsive, pioneering, and fiercely independent.' }
      ],
  ...
  },
  {
    ...
    content: {
      ...
      decans: [
        { decan: 1, description: 'Mercury Sub-ruler (0°-10°): Pure Virgo. Highly analytical, detail-oriented, nervous energy, and deeply focused on perfection and service.' },
        { decan: 2, description: 'Saturn Sub-ruler (10°-20°): Adds Capricorn qualities. More ambitious, stoic, disciplined, and focused on long-term structural success.' },
        { decan: 3, description: 'Venus Sub-ruler (20°-30°): Adds Taurus qualities. More sensual, aesthetically driven, financially focused, and emotionally stable.' }
      ],
  ...
  },
  {
    ...
    content: {
      ...
      decans: [
        { decan: 1, description: 'Venus Sub-ruler (0°-10°): Pure Libra. Highly romantic, diplomatic, aesthetically driven, and extremely focused on partnership.' },
        { decan: 2, description: 'Uranus/Saturn Sub-ruler (10°-20°): Adds Aquarius qualities. More detached, intellectual, humanitarian, and focused on societal justice.' },
        { decan: 3, description: 'Mercury Sub-ruler (20°-30°): Adds Gemini qualities. Highly communicative, curious, versatile, and mentally agile.' }
      ],
  ...
  },
  {
    ...
    content: {
      ...
      decans: [
        { decan: 1, description: 'Pluto/Mars Sub-ruler (0°-10°): Pure Scorpio. Intense, fiercely loyal, deeply transformative, and possesses an all-or-nothing mindset.' },
        { decan: 2, description: 'Neptune/Jupiter Sub-ruler (10°-20°): Adds Pisces qualities. More mystical, empathetic, artistic, and prone to spiritual depth.' },
        { decan: 3, description: 'Moon Sub-ruler (20°-30°): Adds Cancer qualities. Highly protective, deeply emotional, family-oriented, and profoundly intuitive.' }
      ],
  ...
  },
  {
    ...
    content: {
      ...
      decans: [
        { decan: 1, description: 'Jupiter Sub-ruler (0°-10°): Pure Sagittarius. Highly optimistic, philosophical, truthful, and obsessed with freedom and travel.' },
        { decan: 2, description: 'Mars Sub-ruler (10°-20°): Adds Aries qualities. More aggressive, pioneering, impulsive, and ready to fight for their beliefs.' },
        { decan: 3, description: 'Sun Sub-ruler (20°-30°): Adds Leo qualities. Highly charismatic, theatrical, proud, and focused on inspiring others.' }
      ],
  ...
  },
  {
    ...
    content: {
      ...
      decans: [
        { decan: 1, description: 'Saturn Sub-ruler (0°-10°): Pure Capricorn. Supreme discipline, immense ambition, highly pragmatic, and focused on structure.' },
        { decan: 2, description: 'Venus Sub-ruler (10°-20°): Adds Taurus qualities. More focused on material wealth, aesthetic structures, and sensual stability.' },
        { decan: 3, description: 'Mercury Sub-ruler (20°-30°): Adds Virgo qualities. Highly analytical, detail-oriented, communicative, and focused on service.' }
      ],
  ...
  },
  {
    ...
    content: {
      ...
      decans: [
        { decan: 1, description: 'Uranus/Saturn Sub-ruler (0°-10°): Pure Aquarius. Extremely independent, rebellious, brilliant, and focused on breaking boundaries.' },
        { decan: 2, description: 'Mercury Sub-ruler (10°-20°): Adds Gemini qualities. Highly communicative, intellectual, adaptable, and focused on networking.' },
        { decan: 3, description: 'Venus Sub-ruler (20°-30°): Adds Libra qualities. More diplomatic, artistic, relationship-oriented, and focused on societal harmony.' }
      ],
  ...
  },
  {
    ...
    content: {
      ...
      decans: [
        { decan: 1, description: 'Neptune/Jupiter Sub-ruler (0°-10°): Pure Pisces. Supremely empathetic, mystical, artistic, and prone to dissolving all boundaries.' },
        { decan: 2, description: 'Moon Sub-ruler (10°-20°): Adds Cancer qualities. Highly protective, deeply emotional, family-oriented, and profoundly sensitive.' },
        { decan: 3, description: 'Pluto/Mars Sub-ruler (20°-30°): Adds Scorpio qualities. More intense, psychologically penetrating, secretive, and transformative.' }
      ],
...
const fileContentEn = `export interface ZodiacData {
  id: string;
  name: string;
  sanskritName: string;
  element: string;
...
export const zodiacs: ZodiacData[] = ${JSON.stringify(zodiacs, null, 2)};
`;

fs.writeFileSync('src/data/zodiacs.ts', fileContentEn);
console.log('Successfully wrote zodiacs.ts');
