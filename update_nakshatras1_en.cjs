...
const nakshatras1To9 = [
  {
    ...
    content: {
      ...
      fourPadas: [
        { pada: 1, description: "Aries Navamsha (0°00' - 3°20' Aries): Driven by Mars. Highly energetic, athletic, and pioneering, but prone to excessive aggression and impulsiveness." },
        { pada: 2, description: "Taurus Navamsha (3°20' - 6°40' Aries): Driven by Venus. Brings stability, material desires, and a focus on physical beauty and grace. Less impulsive." },
        { pada: 3, description: "Gemini Navamsha (6°40' - 10°00' Aries): Driven by Mercury. Highly communicative, intellectual, and humorous. Excellent for rapid decision-making and writing." },
        { pada: 4, description: "Cancer Navamsha (10°00' - 13°20' Aries): Driven by Moon. Deeply empathetic and healing. This pada focuses heavily on the medical and nurturing side of the Ashwini Kumaras." }
      ],
  ...
  },
  {
    ...
    content: {
      ...
      fourPadas: [
        { pada: 1, description: "Leo Navamsha (13°20' - 16°40' Aries): Driven by Sun. Highly creative, dramatic, and self-centered. Focuses on personal willpower and leadership." },
        { pada: 2, description: "Virgo Navamsha (16°40' - 20°00' Aries): Driven by Mercury. Analytical, practical, and highly organized. Brings a sense of structure to the chaotic Bharani energy." },
        { pada: 3, description: "Libra Navamsha (20°00' - 23°20' Aries): Driven by Venus. The most harmonious and artistic pada. Focuses on relationships, justice, and balancing extremes." },
        { pada: 4, description: "Scorpio Navamsha (23°20' - 26°40' Aries): Driven by Mars. The most intense and transformative pada. Deals heavily with occult, deep psychology, and dramatic rebirth." }
      ],
  ...
  },
  {
    ...
    content: {
      ...
      fourPadas: [
        { pada: 1, description: "Sagittarius Navamsha (26°40' Aries - 0°00' Taurus): Driven by Jupiter. Highly philosophical, moral, and exploratory. Known as the 'military commander' of the zodiac." },
        { pada: 2, description: "Capricorn Navamsha (0°00' - 3°20' Taurus): Driven by Saturn. Highly practical, disciplined, and material-focused. Excellent for building lasting structures and wealth." },
        { pada: 3, description: "Aquarius Navamsha (3°20' - 6°40' Taurus): Driven by Saturn. Humanitarian, unconventional, and visionary. Uses the cutting edge of Krittika to bring societal change." },
        { pada: 4, description: "Pisces Navamsha (6°40' - 10°00' Taurus): Driven by Jupiter. The most nurturing and spiritual pada. Uses fire to heal and guide others, rather than to destroy." }
      ],
  ...
  },
  {
    ...
    content: {
      ...
      fourPadas: [
        { pada: 1, description: "Aries Navamsha (10°00' - 13°20' Taurus): Driven by Mars. The most active and passionate pada of Rohini. Focuses on rapid growth and acquiring material possessions quickly." },
        { pada: 2, description: "Taurus Navamsha (13°20' - 16°40' Taurus): Driven by Venus. Vargottama (same sign in D1 and D9). Represents the peak of material abundance, beauty, and sensual fulfillment." },
        { pada: 3, description: "Gemini Navamsha (16°40' - 20°00' Taurus): Driven by Mercury. Focuses on commerce, communication, and intellectualizing the arts. Highly sociable and business-oriented." },
        { pada: 4, description: "Cancer Navamsha (20°00' - 23°20' Taurus): Driven by Moon. The most emotional and nurturing pada. Deeply attached to family, home, and psychological security." }
      ],
  ...
  },
  {
    ...
    content: {
      ...
      fourPadas: [
        { pada: 1, description: "Leo Navamsha (23°20' - 26°40' Taurus): Driven by Sun. Highly creative and confident. Focuses on searching for self-expression and creative leadership." },
        { pada: 2, description: "Virgo Navamsha (26°40' - 30°00' Taurus): Driven by Mercury. The most analytical and communicative pada. Excellent for deep research, editing, and intellectual pursuits." },
        { pada: 3, description: "Libra Navamsha (0°00' - 3°20' Gemini): Driven by Venus. Focuses heavily on relationships. The search is directed towards finding the perfect partner or perfect aesthetic." },
        { pada: 4, description: "Scorpio Navamsha (3°20' - 6°40' Gemini): Driven by Mars. The most intense pada. The search turns inward to the occult, hidden mysteries, and psychological depths." }
      ],
  ...
  },
  {
    ...
    content: {
      ...
      fourPadas: [
        { pada: 1, description: "Sagittarius Navamsha (6°40' - 10°00' Gemini): Driven by Jupiter. The most philosophical pada. Seeks the deeper meaning behind the storms of life and uses intellect for higher learning." },
        { pada: 2, description: "Capricorn Navamsha (10°00' - 13°20' Gemini): Driven by Saturn. Highly practical and disciplined. Uses the intense Ardra energy to build solid, material foundations after a crisis." },
        { pada: 3, description: "Aquarius Navamsha (13°20' - 16°40' Gemini): Driven by Saturn. Highly scientific, unconventional, and visionary. Excellent for technological innovation and breaking societal norms." },
        { pada: 4, description: "Pisces Navamsha (16°40' - 20°00' Gemini): Driven by Jupiter. The most emotional and compassionate pada. Focuses on resolving sorrow through deep spirituality and healing." }
      ],
  ...
  },
  {
    ...
    content: {
      ...
      fourPadas: [
        { pada: 1, description: "Aries Navamsha (20°00' - 23°20' Gemini): Driven by Mars. The most active and pioneering pada. Focuses on adventuring, traveling, and spreading knowledge aggressively." },
        { pada: 2, description: "Taurus Navamsha (23°20' - 26°40' Gemini): Driven by Venus. Focuses on material comforts, hospitality, and nurturing the physical senses. Highly stable and artistic." },
        { pada: 3, description: "Gemini Navamsha (26°40' - 30°00' Gemini): Driven by Mercury. Highly intellectual, communicative, and scientific. Vargottama pada, maximizing the communicative power of Gemini." },
        { pada: 4, description: "Cancer Navamsha (0°00' - 3°20' Cancer): Driven by Moon. The most spiritual and nurturing pada. Deeply maternal, focused on providing profound emotional safety and healing." }
      ],
  ...
  },
  {
    ...
    content: {
      ...
      fourPadas: [
        { pada: 1, description: "Leo Navamsha (3°20' - 6°40' Cancer): Driven by Sun. Highly dignified and leadership-oriented. Nurtures others by taking charge and providing strong, paternal guidance." },
        { pada: 2, description: "Virgo Navamsha (6°40' - 10°00' Cancer): Driven by Mercury. Highly analytical and service-oriented. Excellent for nursing, accounting, and practical, day-to-day caregiving." },
        { pada: 3, description: "Libra Navamsha (10°00' - 13°20' Cancer): Driven by Venus. Focuses on social harmony, diplomacy, and creating beautiful, comforting environments for others to heal in." },
        { pada: 4, description: "Scorpio Navamsha (13°20' - 16°40' Cancer): Driven by Mars. The most intense and mystical pada. Nurtures the soul through deep psychological transformation and occult wisdom." }
      ],
  ...
  },
  {
    ...
    content: {
      ...
      fourPadas: [
        { pada: 1, description: "Sagittarius Navamsha (16°40' - 20°00' Cancer): Driven by Jupiter. The most spiritual and philosophical pada. Seeks to understand the deep mysteries of life and karma." },
        { pada: 2, description: "Capricorn Navamsha (20°00' - 23°20' Cancer): Driven by Saturn. Highly ambitious and strategic. Uses their psychological insight to build material wealth and overcome enemies." },
        { pada: 3, description: "Aquarius Navamsha (23°20' - 26°40' Cancer): Driven by Saturn. Unconventional and scientific. Excellent for deep research, especially in fringe sciences or technology." },
        { pada: 4, description: "Pisces Navamsha (26°40' - 30°00' Cancer): Driven by Jupiter. The Gandanta (karmic knot) point. Extremely emotional, mystical, and prone to deep spiritual awakenings or profound illusions." }
      ],
...
export const nakshatras1To9: NakshatraData[] = ${JSON.stringify(nakshatras1To9, null, 2)};
`;

fs.writeFileSync('src/data/nakshatras1.ts', fileContentEn);
console.log('Successfully wrote nakshatras1.ts');
