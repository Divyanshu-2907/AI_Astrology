...
const allPlanets = [...planetsPart1, ...planetsPart2];
const allPlanetsString = JSON.stringify(allPlanets, null, 2);
...
export const planets: PlanetData[] = ${allPlanetsString};
`;

fs.writeFileSync('src/data/planets.ts', fileContent);
console.log('Successfully fixed planets.ts!');
